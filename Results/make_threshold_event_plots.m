...
if multi_panel_plot_flag == true
    ...
    % If plotting work percentage scenario, just plot marker for final
    % configuration
    if strcmp(dataset,'workpercent_and_backwardsCT')==1
        idxs_to_plot = 1:(n_scens - 1);
        x_to_plot = xticks_vals(1:end-1);
    else
        idxs_to_plot = 1:n_scens;
        x_to_plot = xticks_vals(1:end);
    end
    
    % Plot the traces
    for trace_itr = 1:n_vars
        if trace_itr == 1
            plot(x_to_plot,threshold_vals(idxs_to_plot,trace_itr),'x-',...
                'Color',colour_array(trace_itr,:),...
                'MarkerSize',12,...
                'LineWidth',1.5)
        elseif trace_itr == 2
            plot(x_to_plot,threshold_vals(idxs_to_plot,trace_itr),'v--',...
                'Color',colour_array(trace_itr,:),...
                'MarkerSize',12,...
                'LineWidth',1.5)
        elseif trace_itr == 3
            plot(x_to_plot,threshold_vals(idxs_to_plot,trace_itr),'o:',...
                'Color',colour_array(trace_itr,:),...
                'MarkerSize',12,...
                'LineWidth',1.5)
         elseif trace_itr == 4
            plot(x_to_plot,threshold_vals(idxs_to_plot,trace_itr),'*-',...
                'Color',colour_array(trace_itr,:),...
                'MarkerSize',12,...
                'LineWidth',1.5)
        elseif trace_itr == 5
            plot(x_to_plot,threshold_vals(idxs_to_plot,trace_itr),'s-.',...
                'Color',colour_array(trace_itr,:),...
                'MarkerSize',12,...
                'LineWidth',1.5)
        end
    ...
    if strcmp(dataset,'workpercent_and_backwardsCT')==1
        % Plot marker for final configuration if applicable
        for trace_itr = 1:n_vars
            if trace_itr == 1
                plot(xticks_vals(end),threshold_vals(end,trace_itr),'x',...
                    'Color',colour_array(trace_itr,:),...
                    'MarkerSize',12,...
                    'LineWidth',1.5)
            elseif trace_itr == 2
                plot(xticks_vals(end),threshold_vals(end,trace_itr),'v',...
                    'Color',colour_array(trace_itr,:),...
                    'MarkerSize',12,...
                    'LineWidth',1.5)
            elseif trace_itr == 3
                plot(xticks_vals(end),threshold_vals(end,trace_itr),'o',...
                    'Color',colour_array(trace_itr,:),...
                    'MarkerSize',12,...
                    'LineWidth',1.5)
             elseif trace_itr == 4
                plot(xticks_vals(end),threshold_vals(end,trace_itr),'*',...
                    'Color',colour_array(trace_itr,:),...
                    'MarkerSize',12,...
                    'LineWidth',1.5)
            elseif trace_itr == 5
                plot(xticks_vals(end),threshold_vals(end,trace_itr),'s',...
                    'Color',colour_array(trace_itr,:),...
                    'MarkerSize',12,...
                    'LineWidth',1.5)
            end
