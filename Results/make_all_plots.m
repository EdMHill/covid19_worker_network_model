...
criteria_thresholds = [0.2,0.01,0.01,150,0.05];
display_legend = true;
...
yticks([0 1 2 3 4 5 6 7])
subplot(3,3,7); ylim([0,7]); subplot(3,3,8); ylim([0,7]); subplot(3,3,9); ylim([0,7]); 
...
yticks([0 1 2 3 4 5 6 7])
subplot(3,2,5); ylim([0,7]); subplot(3,2,6); ylim([0,7]);
